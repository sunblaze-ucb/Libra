...
%\renewcommand{\dawn}[1]{}
%\renewcommand{\fan}[1]{}
\newcommand{\babis}[1]{{\color{magenta}[Babis: #1]}}
...
\author{
	{\sc Tiacheng Xie}\thanks{Department of Electrical Engineering and Computer Science, University of California, Berkeley. {\bf Email:} {\tt \{tianc.x,jiaheng\_zhang,zhangyp,dawnsong\}@berkeley.edu}.}
	\and
	{\sc Jiaheng Zhang$^*$}
	\and
	{\sc Yupeng Zhang$^*$}
	\and
	{\sc Charalampos Papamanthou}\thanks{Department of Electrical and Computer
		Engineering and UMIACS, University of Maryland. {\bf Email:} {\tt cpap@umd.edu}.}
	\and
	{\sc Dawn Song$^*$}
} % end author
\date{}
