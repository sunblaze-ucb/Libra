\begin{abstract}
   ...
   Underlying our new zero knowledge argument scheme is a new variant of the interactive proof protocol by Goldwasser et al. 2008 with linear prover time, and an efficient approach to turn the protocol to zero-knowledge by small masking polynomials.
