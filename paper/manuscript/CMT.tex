...
Instead directly check two points, we can combine these two points into one by linear combination. And recursively check on the combined point of next layer. For the final input layer, the verifier checks the claim by calculating the value by himself.
