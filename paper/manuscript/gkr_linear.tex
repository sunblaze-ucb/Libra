...
\vspace{-.5in}
	\begin{algorithm}[H]
		...
		\begin{algorithmic}[1]
			...
			\State Run Algorithm 1 on $\textbf{H}$ and $\textbf{A}_2$ separately. $\textbf{A}_2$ is the array that defines $f_2$. 
			\For{$i=1,\ldots,\ell$}
			\For{$t\in\{0,1,2\}$}
...
\begin{figure}[t!]
	\begin{algorithm}[H]
		...
		\begin{algorithmic}[1]
			...
			\State Run Algorithm 1 on $\textbf{A}_1$ and $\textbf{A}_3$ separately. $\textbf{A}_3$ is the array that defines $f_3$. 
			\For{$i=1,\ldots,\ell$}
			\For{$t\in\{0,1,2\}$}
