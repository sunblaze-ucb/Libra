...
\begin{lemma}\label{lemma_f_1}
	...
	$f_1(g,u,y) = \sum_{(z,x)\in \mathcal{N}_y}I(g,z)\cdot I(u,y) \cdot f_1(z,x,y)$.
\end{lemma}

\begin{proof}
This immediately follows from the fact that $f_1$ is a multilinear extension. We have $f_1(g,u,y) = \sum_{z,y\in\binary^\ell}I(g,z)\cdot I(u,y) \cdot f_1(z,x,y)$, where the closed from of $I$ is given in Lemma~\ref{lemma_h_g}.
\end{proof}
